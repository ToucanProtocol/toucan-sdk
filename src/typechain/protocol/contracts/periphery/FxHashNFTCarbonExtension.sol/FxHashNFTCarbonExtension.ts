...
export interface FxHashNFTCarbonExtensionInterface extends utils.Interface {
  functions: {
    ...
    'initialize(uint256,address,address[],bytes32[])': FunctionFragment;
...
export interface FxHashNFTCarbonExtension extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FxHashNFTCarbonExtensionInterface;
  ...
  functions: {
    ...
    initialize(
      initialPoolTokenAllocation_: PromiseOrValue<BigNumberish>,
