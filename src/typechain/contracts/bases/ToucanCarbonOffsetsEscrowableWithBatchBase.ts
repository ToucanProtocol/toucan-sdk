...
export interface ToucanCarbonOffsetsEscrowableWithBatchBaseInterface extends utils.Interface {
  functions: {
...
export interface ToucanCarbonOffsetsEscrowableWithBatchBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ToucanCarbonOffsetsEscrowableWithBatchBaseInterface;
