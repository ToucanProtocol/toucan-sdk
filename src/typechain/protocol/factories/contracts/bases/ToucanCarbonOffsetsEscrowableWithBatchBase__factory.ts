...
import type {
  ToucanCarbonOffsetsEscrowableWithBatchBase,
  ToucanCarbonOffsetsEscrowableWithBatchBaseInterface,
} from '../../../contracts/bases/ToucanCarbonOffsetsEscrowableWithBatchBase';
...
export class ToucanCarbonOffsetsEscrowableWithBatchBase__factory {
  static readonly abi = _abi;
  static createInterface(): ToucanCarbonOffsetsEscrowableWithBatchBaseInterface {
    return new utils.Interface(_abi) as ToucanCarbonOffsetsEscrowableWithBatchBaseInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as ToucanCarbonOffsetsEscrowableWithBatchBase;
  }
}
