...
export interface FxGenArt721TestInterface extends utils.Interface {
  functions: {
...
export interface FxGenArt721Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FxGenArt721TestInterface;
