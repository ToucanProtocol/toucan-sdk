...
export interface PoolStorageV1_2Interface extends utils.Interface {
  functions: {
    'redeemFeeExemptedTCO2s(address)': FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: 'redeemFeeExemptedTCO2s'): FunctionFragment;
...
export interface PoolStorageV1_2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolStorageV1_2Interface;
