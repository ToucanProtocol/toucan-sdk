...
export interface ToucanCarbonOffsetsFactoryInterface extends utils.Interface {
  functions: {
...
export interface ToucanCarbonOffsetsFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ToucanCarbonOffsetsFactoryInterface;
  ...
  callStatic: {
    ...
    setAdmin(_user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
