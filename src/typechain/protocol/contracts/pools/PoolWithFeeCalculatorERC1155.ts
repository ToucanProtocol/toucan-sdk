...
export interface PoolWithFeeCalculatorERC1155Interface extends utils.Interface {
  functions: {
...
export interface PoolWithFeeCalculatorERC1155 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolWithFeeCalculatorERC1155Interface;
