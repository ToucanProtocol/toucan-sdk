...
export interface ICarbonProjectVintagesInterface extends utils.Interface {
  functions: {
...
export interface ICarbonProjectVintages extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICarbonProjectVintagesInterface;
