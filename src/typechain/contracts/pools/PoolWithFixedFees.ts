...
export interface PoolWithFixedFeesInterface extends utils.Interface {
  functions: {
...
export interface PoolWithFixedFees extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolWithFixedFeesInterface;
