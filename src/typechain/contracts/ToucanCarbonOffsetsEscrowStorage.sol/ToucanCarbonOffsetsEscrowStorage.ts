...
export interface ToucanCarbonOffsetsEscrowStorageInterface extends utils.Interface {
  functions: {
...
export interface ToucanCarbonOffsetsEscrowStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ToucanCarbonOffsetsEscrowStorageInterface;
