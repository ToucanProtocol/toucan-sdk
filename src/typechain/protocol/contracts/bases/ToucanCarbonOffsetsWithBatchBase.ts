...
export interface ToucanCarbonOffsetsWithBatchBaseInterface extends utils.Interface {
  functions: {
...
export interface ToucanCarbonOffsetsWithBatchBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ToucanCarbonOffsetsWithBatchBaseInterface;
