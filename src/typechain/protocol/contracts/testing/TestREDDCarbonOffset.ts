...
export interface TestREDDCarbonOffsetInterface extends utils.Interface {
  functions: {
...
export interface TestREDDCarbonOffset extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestREDDCarbonOffsetInterface;
