...
export interface IBridgeableTokenInterface extends utils.Interface {
  functions: {
...
export interface IBridgeableToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBridgeableTokenInterface;
