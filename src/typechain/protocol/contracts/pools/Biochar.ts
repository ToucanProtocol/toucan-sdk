...
export interface BiocharInterface extends utils.Interface {
  functions: {
    ...
    'totalPerProjectTCO2Supply(uint256)': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'totalPerProjectTCO2Supply',
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'totalPerProjectTCO2Supply', data: BytesLike): Result;
...
export interface Biochar extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BiocharInterface;
