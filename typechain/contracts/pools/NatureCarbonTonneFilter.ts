...
export interface NatureCarbonTonneFilterInterface extends utils.Interface {
  functions: {
...
export interface NatureCarbonTonneFilter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NatureCarbonTonneFilterInterface;
