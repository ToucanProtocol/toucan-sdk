...
import type {
  PoolWithAdjustingERC1155,
  PoolWithAdjustingERC1155Interface,
} from '../../../contracts/pools/PoolWithAdjustingERC1155';
...
export class PoolWithAdjustingERC1155__factory {
  static readonly abi = _abi;
  static createInterface(): PoolWithAdjustingERC1155Interface {
    return new utils.Interface(_abi) as PoolWithAdjustingERC1155Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PoolWithAdjustingERC1155 {
    return new Contract(address, _abi, signerOrProvider) as PoolWithAdjustingERC1155;
  }
}
