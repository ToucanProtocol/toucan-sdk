...
export interface CarbonOffsetBatchesStorageV1Interface extends utils.Interface {
  functions: {
...
export interface CarbonOffsetBatchesStorageV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CarbonOffsetBatchesStorageV1Interface;
