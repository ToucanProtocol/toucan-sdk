...
export interface ToucanCarbonOffsetsBaseInterface extends utils.Interface {
  functions: {
...
export interface ToucanCarbonOffsetsBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ToucanCarbonOffsetsBaseInterface;
