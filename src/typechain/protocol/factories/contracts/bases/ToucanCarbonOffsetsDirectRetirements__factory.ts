...
import type {
  ...
  ToucanCarbonOffsetsDirectRetirementsInterface,
} from '../../../contracts/bases/ToucanCarbonOffsetsDirectRetirements';
...
export class ToucanCarbonOffsetsDirectRetirements__factory {
  static readonly abi = _abi;
  static createInterface(): ToucanCarbonOffsetsDirectRetirementsInterface {
    return new utils.Interface(_abi) as ToucanCarbonOffsetsDirectRetirementsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ToucanCarbonOffsetsDirectRetirements {
    return new Contract(address, _abi, signerOrProvider) as ToucanCarbonOffsetsDirectRetirements;
  }
}
