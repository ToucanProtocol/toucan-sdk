...
export interface ERC1155AllowableInterface extends utils.Interface {
  functions: {
...
export interface ERC1155Allowable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155AllowableInterface;
