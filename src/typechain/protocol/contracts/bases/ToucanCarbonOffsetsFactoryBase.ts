...
export interface ToucanCarbonOffsetsFactoryBaseInterface extends utils.Interface {
  functions: {
...
export interface ToucanCarbonOffsetsFactoryBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ToucanCarbonOffsetsFactoryBaseInterface;
