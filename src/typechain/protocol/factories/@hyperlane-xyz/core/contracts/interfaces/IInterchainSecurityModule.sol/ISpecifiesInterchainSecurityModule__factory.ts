...
export class ISpecifiesInterchainSecurityModule__factory {
  ...
  static createInterface(): ISpecifiesInterchainSecurityModuleInterface {
    return new utils.Interface(_abi) as ISpecifiesInterchainSecurityModuleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ISpecifiesInterchainSecurityModule {
    return new Contract(address, _abi, signerOrProvider) as ISpecifiesInterchainSecurityModule;
  }
}
