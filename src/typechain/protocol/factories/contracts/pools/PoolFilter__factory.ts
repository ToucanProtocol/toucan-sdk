...
import type { PoolFilter, PoolFilterInterface } from '../../../contracts/pools/PoolFilter';
...
export class PoolFilter__factory {
  static readonly abi = _abi;
  static createInterface(): PoolFilterInterface {
    return new utils.Interface(_abi) as PoolFilterInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PoolFilter {
    return new Contract(address, _abi, signerOrProvider) as PoolFilter;
  }
}
