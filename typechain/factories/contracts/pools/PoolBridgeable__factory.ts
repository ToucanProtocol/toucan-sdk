...
import type {
  PoolBridgeable,
  PoolBridgeableInterface,
} from '../../../contracts/pools/PoolBridgeable';
...
export class PoolBridgeable__factory {
  static readonly abi = _abi;
  static createInterface(): PoolBridgeableInterface {
    return new utils.Interface(_abi) as PoolBridgeableInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PoolBridgeable {
    return new Contract(address, _abi, signerOrProvider) as PoolBridgeable;
  }
}
