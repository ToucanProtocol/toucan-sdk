...
import type {
  PoolBridgeableLegacy,
  PoolBridgeableLegacyInterface,
} from '../../../contracts/pools/PoolBridgeableLegacy';
...
export class PoolBridgeableLegacy__factory {
  static readonly abi = _abi;
  static createInterface(): PoolBridgeableLegacyInterface {
    return new utils.Interface(_abi) as PoolBridgeableLegacyInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PoolBridgeableLegacy {
    return new Contract(address, _abi, signerOrProvider) as PoolBridgeableLegacy;
  }
}
