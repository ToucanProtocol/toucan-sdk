...
export interface FeeCalculatorTestInterface extends utils.Interface {
  functions: {
...
export interface FeeCalculatorTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeeCalculatorTestInterface;
